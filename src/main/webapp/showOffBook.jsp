...
<div class="w_100_l">
	<div class="main">
      <div class="top_banner">
        ...
        <map name="Map" id="Map">
          <area shape="rect" coords="824,247,910,285" href="#" alt="buy now" />
        </map>
        </span>
        <p class="index_hr"></p>
        ...
        <div class="content">   
                ...
                <ul> 
                    ...
                    <li>                     
                        <dl>
                    	<dd><a href="#"><img src="${pageContext.request.contextPath}/Images/book_0${book.imageNo}.jpg" alt="book" /></a></dd>
                        <dt>
                            <p class="book_title"><a href="#" target="_blank">${book.bookName}</a></p>
                            <p class="book_inline">${book.isbn}</p>
                            <p class="book_inline">${book.owner.userId}</p>
